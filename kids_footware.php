...
mysqli_select_db($con,'onlineshopping_database') or die("cannot connect");//connect database and check wheth itis connected
	$query="select * from  footware where Category= '".Kids."'";// select kids data from footware table 
	...
	<form method="post" action=kids_footware.php>
