...
mysqli_select_db($con,'onlineshopping_database') or die("cannot connect");//connect with database and check whether is it connected
	$query="select * from  accessories where Category= '".Men."' " ;//create query for selected data of men from accessories table
	...
	<form method="post" action=men_access.php>
